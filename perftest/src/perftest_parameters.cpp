...
static void init_perftest_params(struct perftest_parameters *user_param)
{
	...
	user_param->output = (enum verbosity_level) - 1;
#ifdef HAVE_CUDA
...
int set_eth_mtu(struct perftest_parameters *user_param)
{
	...
	{
		user_param->curr_mtu = (enum ibv_mtu)(user_param->mtu);
	}
	else
	{
...
static int set_link_layer(struct ibv_context *context, struct perftest_parameters *params)
{
	...
	if (params->dualport == ON)
	{
		...
		if (port_attr.state != IBV_PORT_ACTIVE)
		{
			fprintf(stderr, " Port number %d state is %s\n", params->ib_port2, portStates[port_attr.state]);
			return FAILURE;
		}
...
static void ctx_set_max_inline(struct ibv_context *context, struct perftest_parameters *user_param)
{
	...
	if (user_param->inline_size == DEF_INLINE)
	{
		...
		if (user_param->tst == LAT)
		{
			...
			case WRITE:
				user_param->inline_size = (user_param->connection_type == DC) ? DEF_INLINE_DC : DEF_INLINE_WRITE;
				break;
			case SEND:
				user_param->inline_size = (user_param->connection_type == DC) ? DEF_INLINE_DC : (user_param->connection_type == UD) ? DEF_INLINE_SEND_UD : ((user_param->connection_type == XRC) ? DEF_INLINE_SEND_XRC : DEF_INLINE_SEND_RC_UC);
				break;
			default:
				user_param->inline_size = 0;
			}
...
int parser(struct perftest_parameters *user_param, char *argv[], int argc)
{
	...
	while (1)
	{
		static const struct option long_options[] = {
			...
			{.name = "mtu", .has_arg = 1, .flag = 0, .val = 'm'},
			{.name = "size", .has_arg = 1, .flag = 0, .val = 's'},
			{.name = "iters", .has_arg = 1, .flag = 0, .val = 'n'},
			{.name = "tx-depth", .has_arg = 1, .flag = 0, .val = 't'},
			{.name = "qp-timeout", .has_arg = 1, .flag = 0, .val = 'u'},
			{.name = "sl", .has_arg = 1, .flag = 0, .val = 'S'},
			{.name = "gid-index", .has_arg = 1, .flag = 0, .val = 'x'},
			{.name = "all", .has_arg = 0, .flag = 0, .val = 'a'},
			{.name = "CPU-freq", .has_arg = 0, .flag = 0, .val = 'F'},
			{.name = "connection", .has_arg = 1, .flag = 0, .val = 'c'},
			{.name = "qp", .has_arg = 1, .flag = 0, .val = 'q'},
			{.name = "events", .has_arg = 0, .flag = 0, .val = 'e'},
			{.name = "vector", .has_arg = 1, .flag = 0, .val = 'X'},
			{.name = "inline_size", .has_arg = 1, .flag = 0, .val = 'I'},
			{.name = "outs", .has_arg = 1, .flag = 0, .val = 'o'},
			{.name = "mcg", .has_arg = 0, .flag = 0, .val = 'g'},
			{.name = "comm_rdma_cm", .has_arg = 0, .flag = 0, .val = 'z'},
			{.name = "rdma_cm", .has_arg = 0, .flag = 0, .val = 'R'},
			{.name = "tos", .has_arg = 1, .flag = 0, .val = 'T'},
			{.name = "hop_limit", .has_arg = 1, .flag = 0, .val = 'L'},
			{.name = "help", .has_arg = 0, .flag = 0, .val = 'h'},
			{.name = "MGID", .has_arg = 1, .flag = 0, .val = 'M'},
			{.name = "rx-depth", .has_arg = 1, .flag = 0, .val = 'r'},
			{.name = "bidirectional", .has_arg = 0, .flag = 0, .val = 'b'},
			{.name = "cq-mod", .has_arg = 1, .flag = 0, .val = 'Q'},
			{.name = "noPeak", .has_arg = 0, .flag = 0, .val = 'N'},
			{.name = "version", .has_arg = 0, .flag = 0, .val = 'V'},
			{.name = "report-cycles", .has_arg = 0, .flag = 0, .val = 'C'},
			{.name = "report-histogrm", .has_arg = 0, .flag = 0, .val = 'H'},
			{.name = "report-unsorted", .has_arg = 0, .flag = 0, .val = 'U'},
			{.name = "atomic_type", .has_arg = 1, .flag = 0, .val = 'A'},
			{.name = "dualport", .has_arg = 0, .flag = 0, .val = 'O'},
			{.name = "post_list", .has_arg = 1, .flag = 0, .val = 'l'},
			{.name = "duration", .has_arg = 1, .flag = 0, .val = 'D'},
			{.name = "margin", .has_arg = 1, .flag = 0, .val = 'f'},
			{.name = "source_mac", .has_arg = 1, .flag = 0, .val = 'B'},
			{.name = "dest_mac", .has_arg = 1, .flag = 0, .val = 'E'},
			{.name = "dest_ip", .has_arg = 1, .flag = 0, .val = 'J'},
			{.name = "source_ip", .has_arg = 1, .flag = 0, .val = 'j'},
			{.name = "dest_port", .has_arg = 1, .flag = 0, .val = 'K'},
			{.name = "source_port", .has_arg = 1, .flag = 0, .val = 'k'},
			{.name = "ethertype", .has_arg = 1, .flag = 0, .val = 'Y'},
			{.name = "limit_bw", .has_arg = 1, .flag = 0, .val = 'w'},
			{.name = "limit_msgrate", .has_arg = 1, .flag = 0, .val = 'y'},
			{.name = "server", .has_arg = 0, .flag = 0, .val = 'Z'},
			{.name = "client", .has_arg = 0, .flag = 0, .val = 'P'},
			{.name = "mac_fwd", .has_arg = 0, .flag = 0, .val = 'v'},
			{.name = "use_rss", .has_arg = 0, .flag = 0, .val = 'G'},
			{.name = "report-counters", .has_arg = 1, .flag = 0, .val = 'W'},
		...
		case 'm':
			...
			break;
		case 'n':
			CHECK_VALUE(user_param->iters, int, MIN_ITER, MAX_ITER, "Iteration num");
			break;
		case 't':
		...
		case 'T':
			...
			break;
		case 'L':
			CHECK_VALUE(user_param->hop_limit, int, MIN_HOP_LIMIT, MAX_HOP_LIMIT, "Hop Limit");
			break;
		case 'u':
		...
		case 'S':
			...
			break;
		case 'x':
			CHECK_VALUE(user_param->gid_index, uint8_t, MIN_GID_IX, MAX_GID_IX, "Gid index");
			user_param->use_gid_user = 1;
			break;
		case 'c':
			change_conn_type(&user_param->connection_type, user_param->verb, optarg);
			break;
		case 'q':
			if (user_param->tst != BW)
			{
...
void print_report_bw(struct perftest_parameters *user_param, struct bw_report_data *my_bw_rep)
{
	...
	if (!user_param->duplex || (user_param->verb == SEND && user_param->test_type == DURATION) || user_param->test_method == RUN_INFINITELY || user_param->connection_type == RawEth)
...
void print_full_bw_report(struct perftest_parameters *user_param, struct bw_report_data *my_bw_rep, struct bw_report_data *rem_bw_rep)
{
	...
	printf("[%s] ", user_param->servername);
...
{
	const cycles_t *a = (const cycles_t *)aptr;
	const cycles_t *b = (const cycles_t *)bptr;
	if (*a < *b)
		return -1;
	if (*a > *b)
		return 1;
