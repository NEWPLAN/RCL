...
{       
        ...
        qp_attr->cap.max_send_wr = 10;  // Maximum # of outstanding send requests in the send queue
        qp_attr->cap.max_recv_wr = 10;  // Maximum # of outstanding receive requests in the receive queue
        qp_attr->cap.max_send_sge = 1;
        qp_attr->cap.max_recv_sge = 1;
}

// Register send/receive memory of a connection
